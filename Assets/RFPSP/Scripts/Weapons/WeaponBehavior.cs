...
public class WeaponBehavior : MonoBehaviour {
    ...
    public bool ShowWeaponType = true;
	[HideInInspector]
	...
	void Start (){
        ...
        weaponTypeText = FPSPlayerComponent.WeaponTypeText;
        if (ShowWeaponType)
        {
            ShowWeaponTypeText();
        }
    ...
    private void ShowWeaponTypeText()
    {
        switch (weaponType)
        {
            case WeaponType.Primary:
                weaponTypeText.text = "Primary";
                break;
            case WeaponType.Secondary:
                weaponTypeText.text = "Secondary";
                break;case WeaponType.Melee:
                weaponTypeText.text = "Melee";
                break;
        }
    }
